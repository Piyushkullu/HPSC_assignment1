...
module constants
    ...
    integer, parameter :: N = 24  ! number of particles
    ...
    integer, parameter :: output_unit_position = 10 ! unit number for .xyz file for fortran to write
    integer, parameter :: kinetic_unit_position = 11 ! unit number for kinetic.txt to write
